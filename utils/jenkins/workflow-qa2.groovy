...
node('master') {
  withCredentials([[$class: 'StringBinding', credentialsId: 'ibdev_aws_access_key_id', variable: 'AWS_ACCESS_KEY_ID'],
                   [$class: 'StringBinding', credentialsId: 'ibdev_aws_secret_access_key', variable: 'AWS_SECRET_ACCESS_KEY']]) {
