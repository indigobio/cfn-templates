...
EOF
  ...
  dynamic!(:launch_config_chef_bootstrap, 'compute', :instance_type => 'm3.medium', :create_ebs_volumes => false, :security_groups => lookup.get_security_groups(vpc), :chef_run_list => 'role[base],role[compute_executor]')
