...
EOF
  ...
  dynamic!(:launch_config_chef_bootstrap, 'couchbase', :instance_type => 'm3.medium', :security_groups => lookup.get_security_groups(vpc), :chef_run_list => 'role[base],role[couchbase_server]')
