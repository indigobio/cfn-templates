...
EOF
  ...
  dynamic!(:scheduled_action, 'purgery_down', :autoscaling_group => 'PurgeryAsg', :min_size => 0, :desired_capacity => 0, :max_size => 0, :recurrence => '0 6 * * *')
  dynamic!(:scheduled_action, 'purgery_up', :autoscaling_group => 'PurgeryAsg', :min_size => 0, :desired_capacity => 1, :max_size => 1, :recurrence => '0 4 * * 1-5')
end