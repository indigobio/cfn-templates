...
EOF
  ...
  if ENV['autoscale'].to_s == 'true'
    dynamic!(:scheduled_action_down, 'reportcatcher', :autoscaling_group => :reportcatcher_asg)
    dynamic!(:scheduled_action_up, 'reportcatcher', :autoscaling_group => :reportcatcher_asg)
  end
end
