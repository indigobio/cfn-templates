SparkleFormation.build do
  ...
  mappings(:region_to_precise_ami) do
    set!('us-east-1'.disable_camel!, :ami => 'ami-dbd2bdbe') # ami-a7558fcc
    set!('us-west-1'.disable_camel!, :ami => 'ami-d335cf97') # ami-039b6747
    set!('us-west-2'.disable_camel!, :ami => 'ami-a10c1191') # ami-2d6e601d
