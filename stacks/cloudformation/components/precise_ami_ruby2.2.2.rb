SparkleFormation.build do
  ...
  mappings(:region_to_precise_ami) do
    set!('us-east-1'._no_hump, :ami => 'ami-3de38358') # ami-a7558fcc
    set!('us-west-1'._no_hump, :ami => 'ami-ab6f94ef') # ami-039b6747
    set!('us-west-2'._no_hump, :ami => 'ami-c78291f7') # ami-2d6e601d
